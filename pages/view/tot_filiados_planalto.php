...
$arquivo='Membros_PLANALTO.xls';

$html='';
$html.='<table border="1">';
$html.='<tr>';
$html.='<td colspan="12">Total Membros - PLANALTO</td>';
$html.='</tr>';
...
//Selecionar todos os itens da tabela 
		  ...
		  $sql = " SELECT matricula,nome,funcao,congregacao,status FROM filiado WHERE congregacao = 'PLANALTO'";
		  $sql = $pdo->query($sql);
