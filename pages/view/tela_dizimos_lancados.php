...
<hr style="border:1px solid #008000;">
  ...
  <button type="submit" class="form-group btn btn-primary">Pesquisar</button>
	...
	<a href="../view/tela_pesquisa_dizimista.php" style="text-decoration:none">Voltar</a>
...
<div class="col-md-12">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="../view/tela_imprimir_comprovante.php?&id_dizimo=<?php echo $linhas['id_dizimo']; ?>">Comprovante</a></td>
