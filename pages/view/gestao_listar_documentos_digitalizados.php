...
<?php   
      ...
      $sql = "SELECT * FROM docDigitalizados";
      $sql = $pdo->query($sql);  ?>
...
<div class="col-md-12">
  ...
  <tbody>
      ...
      <td><?php echo $linhas['id_digitalizados'];?></td>
      ...
      <td><a href="../documentos/Digitalizados/<?php echo $linhas['arquivo'];?>" title="Baixe arquivo" download><img src="../imagens/diversas_imagens/download.png" width="20" height="20"></a></td>
      <td><a href="../procedimentos/excluir_documento.php?&id=<?php echo $linhas['id_digitalizados']; ?>"><img src="../imagens/diversas_imagens/excluir.png"width="30" height="20" ></a></td>
