...
<body>
  ...
  <div class="container">
   <form novalidate class="needs-validation" action="procedimento_cad_eventos.php"  method="POST">

    <div class="form-row">        
        <div class="col form-group">
           <label for="nome">Evento</label>
           <input type="text" name="evento" class="form-control is-valid" id="descricao" required>
        </div>
    </div><!-- end div-form-row-->  
    <div class="form-row">        
        <div class="col form-group">
           <label for="nome">Anotações</label>
           <textarea type="text" name="anotacoes" class="form-control is-valid" id="descricao" required></textarea>
        </div>
    </div><!-- end div-form-row--> 
    <div class="form-row">        
        <div class="col form-group">
    ...
    <div class="form-row">     
        ...
        <label for="nome">Data do Evento</label>
           <input type="date" name="dt_evento" class="form-control is-valid" id="qtde" required>
        </div>
    </div><!-- end div-form-row-->
    ...
    <a  href="tela_lista_eventos.php"class="btn btn-info btn-block">Lista Eventos Agendados</a>  
