...
$arquivo='Membros_PARQUE NOVO IRACEMA.xls';

$html='';
$html.='<table border="1">';
$html.='<tr>';
$html.='<td colspan="12">Total Membros - PARQUE NOVO IRACEMA</td>';
$html.='</tr>';
...
//Selecionar todos os itens da tabela 
		  ...
		  $sql = " SELECT matricula,nome,funcao,congregacao,status FROM filiado WHERE congregacao = 'NOVO PARQUE IRACEMA'";
		  $sql = $pdo->query($sql);
