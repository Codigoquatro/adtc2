...
$arquivo='Membros_SEDE.xls';

$html='';
$html.='<table border="1">';
$html.='<tr>';
$html.='<td colspan="12">Total Membros - SEDE</td>';
$html.='</tr>';
...
//Selecionar todos os itens da tabela 
		  ...
		  $sql = " SELECT matricula,nome,funcao,congregacao,status FROM filiado WHERE congregacao = 'SEDE'";
		  $sql = $pdo->query($sql);
