        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h4>Total Filiados</h4>
                <p><?php echo $total;?></p>
              </div>
              <div class="icon">
                <i class="ion ion-bag"></i>
              </div>
              <a href="#" class="small-box-footer">ADTC2<i class="fas fa"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h4>22<sup style="font-size: 20px"></sup></h4>
                <p>Congregações</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="#" class="small-box-footer"><?php echo $_SESSION['nome']?><i class="fas fa"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
