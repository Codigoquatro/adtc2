...
if($congregacao === "Alves" || $congregacao==="Marcos"){
    ...
    $sql = "SELECT * FROM dizimo LIMIT $indiceInicio, $porPagina";
    $query = $pdo->query($sql);
} else {
                            ...
                            if (isset($query) && $query->rowCount() > 0) {
                                foreach ($query->fetchAll() as $linhas) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="procedimento_excluir_dizimo.php?id_dizimo=<?php echo $linhas['id_dizimo']; ?>">
                                                <img src="../../imagens/diversas_imagens/excluir.png" width="25" height="20">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="tela_alterar_dizimo.php?id_dizimo=<?php echo $linhas['id_dizimo']; ?>">
                                                <img src="../../imagens/diversas_imagens/editar.png" width="25" height="20">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="tela_comprovante_dizimo.php?id_dizimo=<?php echo $linhas['id_dizimo']; ?>">
