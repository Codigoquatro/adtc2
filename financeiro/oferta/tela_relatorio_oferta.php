...
<body>
  ...
  <div class="container">
   <form novalidate class="needs-validation" action="relatorios_oferta.php"  method="GET">
    ...
    <button type="submit" class="btn btn-primary btn-block">Gerar Relatório Pdf</button>  
     <a href="tela_relatorio_oferta_excel.php"type="submit" class="btn btn-primary btn-block">Gerar Relatório em Excel</a>    
   </form><!-- end form-->
