                            ...
                            if (isset($query) && $query->rowCount() > 0) {
                                foreach ($query->fetchAll() as $linhas) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="procedimento_excluir_oferta.php?id_ofertas=<?php echo $linhas['id_ofertas']; ?>">
                                                <img src="../../imagens/diversas_imagens/excluir.png" width="25" height="20">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="tela_alterar_oferta.php?id_ofertas=<?php echo $linhas['id_ofertas']; ?>">
                                                <img src="../../imagens/diversas_imagens/editar.png" width="25" height="20">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="tela_comprovante_oferta.php?id_ofertas=<?php echo $linhas['id_ofertas']; ?>">
