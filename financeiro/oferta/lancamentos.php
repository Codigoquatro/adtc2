        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="../oferta/tela_pesquisar_ofertas.php" class="small-box-footer">Ofertas Lançados<i class="fas fa-arrow-circle"></i></a>
            </div>
          </div>
          <!-- ./col -->
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-primary">
              ...
              <a href="../oferta/tela_cadastro.php" class="small-box-footer">Ofertas<i class="fas fa-arrow-circle"></i></a>
            </div>
          </div>
          <!-- ./col -->
