...
<body>
  <nav class="navbar navbar-dark bg-dark">
    <a href="../../index_tesoureiro.php" class="navbar-brand">Listar Ofertas</a>
  </nav>
  <div class="container">
   <form novalidate class="needs-validation" action="tela_lista_oferta.php"  method="GET">

    <div class="form-row">     
        <div class="col form-group">       
        <label for="nome">Listar ofertas</label>
