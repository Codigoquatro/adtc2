...
<body>
  <nav class="navbar navbar-dark bg-dark">
    <a href="../../index_tesoureiro.php" class="navbar-brand">Lançamento Saidas | Usuário : <?php echo $_SESSION['nome'] ?></a>
  </nav>
  <div class="container">
   <form novalidate class="needs-validation" action="procedimento_cad_saida.php"  method="POST" enctype="multipart/form-data">

    <div class="form-row">        
        <div class="col form-group">
           <label for="nome">Data da Saida</label>
           <input type="date" name="datasaida" class="form-control is-valid" id="descricao" required>
        </div>
    ...
    <div class="form-row">     
        ...
        <input type="text" name="valor" class="form-control is-valid" id="" required>
        </div>
    </div><!-- end div-form-row-->
    ...
    <div class="form-row">     
        ...
        <input type="text" name="descricao" class="form-control is-valid" id="" required>
        </div>
    </div><!-- end div-form-row-->
    ...
    <a  href="tela_pesquisar_saidas.php"class="btn btn-info btn-block">Listar Saída</a>  
