...
<body>
  ...
  <div class="container">
   <form novalidate class="needs-validation" action="relatorios_saida_excel.php"  method="GET">
    ...
    <a href="tela_relatorio_saida.php"type="submit" class="btn btn-primary btn-block">Voltar</a>     
   </form><!-- end form-->
