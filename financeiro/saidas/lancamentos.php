        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="../saidas/tela_pesquisar_saidas.php" class="small-box-footer">Saidas Lançados<i class="fas fa-arrow-circle"></i></a>
            </div>
          </div>
          <!-- ./col -->
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-primary">
              ...
              <a href="../saidas/tela_cadastro.php" class="small-box-footer">Saidas<i class="fas fa-arrow-circle"></i></a>
            </div>
          </div>
          <!-- ./col -->
