...
<body>
  ...
  <div class="container">
   <form novalidate class="needs-validation" action="relatorios_saida.php"  method="GET">
    ...
    <a href="tela_relatorio_saida_excel.php"type="submit" class="btn btn-primary btn-block">Gerar Relatório em Excel</a>     
   </form><!-- end form-->
