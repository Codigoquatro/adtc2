...
<style>
  ...
  <div class="container">
        ...
        <div id = "funcao" class = "col-12-sm"><p style="text-align:center"><?php echo $linhas['funcao'];?></p></div>
        <div id = "congregacao" class = "col-12-sm"><p style="text-align:center"><?php echo $linhas['congregacao'];?></p></div>    
        </div>
...
<script>
        ...
        '../carteira/imagens/CARTEIRA DE CONGREGADO.png',   
        ];
