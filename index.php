  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index_tesoureiro.php" class="nav-link">Financeiro</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="carteira/carteira.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cartão de Membro</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="eventos/tela_cadastro.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="view/baixar_arquivo.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Relatórios</p>
                </a>
              </li>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="#" class="small-box-footer">Campo </i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h4>Agendamento Buffet<sup style="font-size: 20px"></sup></h4>            
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <a href="agendamentos/tela_cadastro.php" class="small-box-footer">Cadastrar</i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="patrimonio/tela_cadastro.php" class="small-box-footer">Cadastrar<i class="fa-solid fa-arrow-up-right-from-square"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="eventos/tela_cadastro.php" class="small-box-footer">Cadastrar<i class="fas fa"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
