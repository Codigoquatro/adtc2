...
if (!isset($_SESSION['nome']) and !isset($_SESSION['senha']) )
 ...
 <?php   
  require_once "../db/config.php";  
       ...
       $sql    = "SELECT * FROM ofertas LIMIT 10";
       $sql    = $pdo->query($sql);
?>
<!DOCTYPE html>
<html>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form action="tela_resultado_pesquisa_oferta_lancados_data.php" method="get">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form action="tela_resultado_pesquisa_oferta_lancados_nome.php" method="get">
                  <div class="input-group input-group-sm" style="width: 150px;">
