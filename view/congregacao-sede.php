    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">SEDE | Lançamentos</h3>
        ...
        <div class="card-body">
          ...
          <a href="tela_cad_saidas.php"type="button" class="btn btn-warning btn-lg btn-block">Lançamentos saídas</a>          
        </div>
        <!-- /.card-body -->
      </div>
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">SEDE | Consultas</h3>
          <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
              <i class="fas fa-minus"></i></button>           
          </div>
        ...
        <div class="card-body">
          <a href="tela_dizimos_lancados_sede.php"type="button" class="btn btn-success btn-lg btn-block">Consultas dizimos</a>
