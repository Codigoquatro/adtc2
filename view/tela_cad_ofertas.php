...
<body>
  <nav class="navbar navbar-dark bg-dark">
    <a href="" class="navbar-brand">ADTC2 - Ofertas</a>
  </nav>
  <div class="container">
   <form novalidate class="needs-validation" action="../procedimentos/cadastrar_ofertas.php"  method="POST" >

    <div class="form-row">        
        <div class="col form-group">
           <label for="dataOferta">Data</label>
           <input type="date" name="dataOferta" class="form-control is-valid" id="dataOferta" required>
