...
<?php   
      require_once "../db/config.php";
       ...
       $sql    = "SELECT * FROM saidas WHERE congregacao LIKE '$congregacao%' LIMIT 10";
       $sql    = $pdo->query($sql);
?>
<!DOCTYPE html>
<html>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="tela_saidas_lancados_campo.php" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Saídas do Campo</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="tela_saidas_lancados_campo.php">Nova pesquisa</a></li>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Consultar saídas do campo</h3>
