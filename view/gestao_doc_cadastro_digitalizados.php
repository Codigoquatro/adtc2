...
<head>
	...
	<title>Cadastro Documentos Digitalizados</title>
</head>
<body>
<div class="conteiner">
    <div class="row">
		...
		<div class="col-sm-9 float-left  bg-info"style="border:1px solid #ccc;margin-top:48px;padding:10px 10px; ">
                     <form id="frmRegistro" name="form1" action="../procedimentos/cadastro_doc_digitalizados.php"  method="post" enctype="multipart/form-data" style="border:1px solid #008000;margin-top:10px;padding:10px;margin-right:0px;background-color:#FF4500;">        
	<div class="form-row">


		  <div class="form-group col-md-6">
            Gravar Documento Digitalizado			      
