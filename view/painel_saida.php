...
<head>
  ...
  <title>ADTC System | Dashboard Saida</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard Saídas</h1>
          </div><!-- /.col -->
          <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h4>Controle de Saídas</h4>     
              </div>
              <div class="icon">
                <i class="ion ion-bag"></i>
              </div>
              <a href="tela_cad_saidas.php" class="small-box-footer">Entrar<i class=""></i></a>
            </div>
          </div>
          <!-- ./col -->
