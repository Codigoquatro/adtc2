...
if (!isset($_SESSION['nome']) and !isset($_SESSION['senha']) )
 ...
 <?php   
  require_once "../db/config.php";  
       ...
       $sql    = "SELECT * FROM dizimo LIMIT 10";
       $sql    = $pdo->query($sql);
?>
<!DOCTYPE html>
<html>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="tela_dizimos_lancados.php">Home</a></li>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form action="tela_resultado_pesquisa_dizimo_lancados_data.php" method="get">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form action="tela_resultado_pesquisa_dizimo_lancados_nome.php" method="get">
                  <div class="input-group input-group-sm" style="width: 150px;">
