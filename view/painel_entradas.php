...
<head>
  ...
  <title>ADTC System | Dashboard Entrada</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard Entradas</h1>
          </div><!-- /.col -->
          <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-lg-4 col-8">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h4>Controle de Ofertas</h4>

                <p></p>
              </div>
              <div class="icon">
                <i class="ion ion-bag-danger"></i>
              </div>
              <a href="tela_cad_ofertas.php" class="small-box-footer"><i class="fas fa-arrow-circle">Entrar</i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-8">
            ...
            <div class="small-box bg-info">
              ...
              <a href="tela_pesquisa_dizimista.php" class="small-box-footer"><i class="fas fa-arrow-circle">Entrar</i></a>
            </div>
          </div>
        </div>
