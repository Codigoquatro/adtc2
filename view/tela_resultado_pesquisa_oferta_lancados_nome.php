...
<?php   
      require_once "../db/config.php";     
       ...
       $sql    = "SELECT * FROM ofertas WHERE congregacao LIKE '$congregacao%' LIMIT 10";
       $sql    = $pdo->query($sql);
?>
<!DOCTYPE html>
<html>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="tela_oferta_lancados_campo.php">Nova pesquisa</a></li>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Consultaro fertas do campo</h3>
