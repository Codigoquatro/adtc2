...
$arquivo='Membros_NM1.xls';

$html='';
$html.='<table border="1">';
$html.='<tr>';
$html.='<td colspan="12">Total Membros -NM1</td>';
$html.='</tr>';
...
//Selecionar todos os itens da tabela 
		  ...
		  $sql = " SELECT matricula,nome,funcao,congregacao,logradouro,endereco,numero,telefone,status FROM filiado WHERE congregacao = 'NOVO MARANGUAPE 1'";
		  $sql = $pdo->query($sql);
