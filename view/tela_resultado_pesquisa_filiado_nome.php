...
<?php if($sql->rowCount() > 0): ?>
   ...
   ?>
    ...
    <div class="container">
       ...
       <div class="col-sm-6" id="foto_resultado" style="text-align: center; margin-top: 20px;">
         <img class="img-thumbnail rounded-circle" src="../imagens/<?php echo $linhas['arquivo'];?>" width="200" height="200" style="margin-top: 40px;border-radius: 50% ">
       </div>
