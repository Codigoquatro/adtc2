...
<div class="container">
    ...
    <form id="frmRegistro" name="frmRegistro" action="../procedimentos/alterar_carta.php" method="POST" enctype="multipart/form-data" style="border: 1px solid #c3c9c5; margin-top: 10px; padding: 10px; margin-right: 0px; background-color: #c3c9c5; border-radius: 10px;">
        <div class="form-row" style="border-radius: 10px; padding: 10px; background-color: #c3c9c5">
            <div class="form-group col-md-12" id="label_cor">
                <label for="carta" id="label_cor">Anexar Carta</label>
                <input type="file" class="form-control" id="cartas" name="cartas">
            </div>
            <div class="col-md-3">
                <input class="form-control" type="hidden" name="matricula" value="<?php echo $resultado['matricula'] ?>">
            </div>  
        </div><br>  
        <button id="registro" type="submit" name="button" class="btn btn-secondary" style="border-radius: 10px;">Anexar carta</button>
    </form>
            ...
            <form id="frmRegistro" name="form1" action="../procedimentos/alterar_filiado.php" method="POST" enctype="multipart/form-data" style="border:1px solid #c3c9c5;margin-top:10px;padding:10px;margin-right:0px;background-color:#d49757;">
                ...
                <div class="form-row">
                    <div class="form-group col-md-8" id="label_cor">
                        <label for="cartas" id="label_cor">Carta</label>
                        <input type="text" class="form-control" id="cartas" name="cartas" value="<?php echo $resultado['cartas'] ?>">
                    </div>
                    <div class="form-group col-md-8" id="label_cor">
                        <label for="arquivo" id="label_cor">Foto</label>
