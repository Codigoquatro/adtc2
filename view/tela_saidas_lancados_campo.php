...
if (!isset($_SESSION['nome']) and !isset($_SESSION['senha']) )
 ...
 <?php   
  require_once "../db/config.php";  
       ...
       $sql    = "SELECT * FROM saidas LIMIT 10";
       $sql    = $pdo->query($sql);
?>
<!DOCTYPE html>
<html>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Saída do Campo</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="painelReport.php">Home</a></li>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form action="tela_resultado_pesquisa_saida_lancados_data.php" method="get">
                  <div class="input-group input-group-sm" style="width: 150px;">
                    <input type="date" name="data" class="form-control float-right" placeholder="Search">
              ...
              <div class="card">
              <div class="card-header">
                <h3 class="card-title">Consultar por congregacao</h3>
                <div class="card-tools">
                  <form action="tela_resultado_pesquisa_saida_lancados_nome.php" method="get">
                  <div class="input-group input-group-sm" style="width: 150px;">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <td><a class="btn btn-primary" href="#">Excluir</a></td>  
                    </tr>
                    <tr>
                  </tbody>
                  <?php 
