...
$totalRegistros = $pdo->query("SELECT COUNT(*) FROM docdigitalizados")->fetchColumn();
...
$sql = "SELECT * FROM docdigitalizados LIMIT $indiceInicio, $porPagina";
$query = $pdo->query($sql);
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<div class="col-md-12">
  ...
  <tbody>
      ...
      <td><a href="../procedimentos/excluir_documento_digitalizados.php?&id_digitalizados=<?php echo $linhas['id_digitalizados']; ?>"><img src="../imagens/diversas_imagens/excluir.png"width="30" height="20" ></a></td>
