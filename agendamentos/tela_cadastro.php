...
<body>
  ...
  <div class="container">
   <form novalidate class="needs-validation" action="procedimento_cad_agendamento.php"  method="POST" enctype="multipart/form-data">

    <div class="form-row">        
        <div class="col form-group">
           <label for="nome">Solicitante</label>
           <input type="text" name="solicitante" class="form-control is-valid" id="descricao" required>
        </div>
    ...
    <div class="form-row">        
        <div class="col form-group">
            ...
            <option>Selecione</option>
                      ...
                      <option>EVENTO DE  DEPARTAMENTO IGREJA</option>
                      <option>REUNIÃO</option>
                      <option>CHÁ DE FRALDA</option>
    ...
    <div class="form-row">     
        ...
        <input type="text" name="horario" class="form-control is-valid" id="horario" required>
        </div>
    </div><!-- end div-form-row-->
    <div class="form-row">     
        <div class="col form-group">       
        <label for="nome">Data do Evento</label>
           <input type="date" name="data_evento" class="form-control is-valid" id="qtde" required>
        </div>
    </div><!-- end div-form-row-->
    <div class="form-row">     
        <div class="col form-group">       
        <label for="nome">Telefone</label>
        <input type="text" name="telefone" class="form-control is-valid" id="telefone" required>
        </div>
    </div><!-- end div-form-row-->
    ...
    <a  href="tela_lista_agendamento.php"class="btn btn-info btn-block">Listar Agendamentos</a>  
