...
<style>
  ...
  <div class="texto4">
    ...
    <div class="texto5">
      ...
      <p class="center-text"><strong>Eribaldo Medeiros Coelho</strong></p>        
      <p id="pastor" class="center-text">Pastor-Presidente</p>
    </div>
    <div class="texto6">
      <p class="center-text"><strong>Secretaria Geral ADTC2</strong></p>        
      <p id="sec" class="center-text">Secretario</p>
    </div>
